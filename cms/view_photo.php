                                      ...
                                      ?>
                                        <tbody>
                                          <?php foreach($product_set as $ps): ?>
                                            ...
                                            <td> <img src='../photo/<?php echo $ps->image; ?>' alt='Photo' class='img-rounded' style='width:120px; height: 100px;'></td>

                                              
                                            <td>
                                                 <a href="edit_photo.php?id=<?php echo $ps->id; ?>">
                                                <button type="button" class="btn btn-primary btn-xs">Edit <i class="fa fa-pencil"></i></button>
                                                </a>
												 <a href="delete_photo.php?id=<?php echo $ps->id; ?>" onClick="return confirm('Are you sure to delete - <?php echo $ps->id; ?>?');">
