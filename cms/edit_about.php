...
if(empty($_GET['id'])) {
  ...
  $session->message_type("warning");
  redirect_to('view_about.php');
}else{
  $sel_product = about::find_by_id($_GET['id']);
}
?>
<?php
  if(request_is_post() && request_is_same_domain()) {
    ...
    $message_type = "danger";
      ...
      $pl = about::find_by_id($_GET['id']);
      $pl->content = $_POST['content'];
      $pl->sub_content = $_POST['sub_content'];
     ...
     if (!empty($_FILES["uploadedimage"]["name"])) {
      ...
      $image= uniqid().$ext;
      $pl->image = $image;
       move_uploaded_file($temp_name, "../about/".$image);
       $path="../about/".$image;
     ...
     else
     {
      ...
      if($pl->save()) {
        ...
        $session->message("About Successfully Updated.");
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="form" action="edit_about.php?id=<?php echo $sel_product->id; ?>" method="post" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                                       ...
                                       <div class="item form-group">
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">sub_content<span class="text-danger">*</span></label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea name="sub_content" rows="6" cols="6"  placeholder="sub_content" class="form-control col-md-7 col-xs-12"><?php echo $sel_product->sub_content; ?></textarea>
                                                <script type="text/javascript" src="ckeditor/ckeditor.js"></script>
                                                <script type="text/javascript">CKEDITOR.replace('content',{height: '300', width: '700' } );</script>
                                            </div>
                                        </div>
                                         ...
                                         <div id="kv-avatar-errors" class="control-label col-md-3 col-sm-3 col-xs-12" style="width:800px;display:none"></div>
                                           ...
                                           <div class="col-md-9"> 
                                           <label class="control-label col-md-4 col-sm-4 col-xs-12">Present Image </label>
                                           <div class="kv-avatar center-block" style="width:200px">
                                              <img src='../about/<?php echo $sel_product->image; ?>' alt='Photo' class='img-rounded' style='width:120px; height: 100px;'>
                                            </div>
                                           </div>
                                         </div>
                                         <div class="form-group">
                                         <div id="kv-avatar-errors" class="control-label col-md-3 col-sm-3 col-xs-12" style="width:800px;display:none"></div>
                                           ...
                                           <div class="col-md-9"> 
                                           <label class="control-label col-md-4 col-sm-4 col-xs-12">New Image Upload </label>
                                           <div class="kv-avatar center-block" style="width:200px">
