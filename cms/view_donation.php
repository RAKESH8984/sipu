                                ...
                                <div class="x_content">
                                    <table id="example" class="table table-striped responsive-utilities jambo_table ">
                                        ...
                                        <?php
                                          ...
                                          $product_set = donations::find_all();
                                      ...
                                      ?>
                                        <tbody>
                                          <?php foreach($product_set as $ps): ?>
											...
											<td><?php echo $ps->amount; ?></td>
										    
                                          
                                              
                                            <td>
                                                 <a href="edit_donation.php?id=<?php echo $ps->id; ?>">
                                                <button type="button" class="btn btn-primary btn-xs">Edit <i class="fa fa-pencil"></i></button>
                                                </a>
                                              <a href="delete_donation.php?id=<?php echo $ps->id; ?>" onClick="return confirm('Are you sure to delete the donation - <?php echo $ps->id; ?>?');">
