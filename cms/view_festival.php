                                      ...
                                      ?>
                                        <tbody>
                                          <?php foreach($product_set as $ps): ?>
                                            ...
                                            <td> <img src='../festival/<?php echo $ps->image; ?>' alt='Photo' class='img-rounded' style='width:120px; height: 100px;'></td>

                                              
                                            <td>
                                                 <a href="edit_festival.php?id=<?php echo $ps->id; ?>">
