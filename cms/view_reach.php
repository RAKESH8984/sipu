                                      ...
                                      ?>
                                        <tbody>
                                          <?php foreach($product_set as $ps): ?>
                                            ...
                                            <td> <img src='../reach/<?php echo $ps->image; ?>' alt='Photo' class='img-rounded' style='width:120px; height: 100px;'></td>

                                              
                                            <td>
                                                 <a href="edit_reach.php?id=<?php echo $ps->id; ?>">
