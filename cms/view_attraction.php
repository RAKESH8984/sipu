                                ...
                                <div class="x_content">
                                    <table id="example" class="table table-striped responsive-utilities jambo_table ">
                                        ...
                                        <?php
                                          ...
                                          $product_set = attraction::find_all();
                                      ...
                                      ?>
                                        <tbody>
                                          <?php foreach($product_set as $ps): ?>
                                            ...
                                            <td> <img src='../attraction/<?php echo $ps->image; ?>' alt='Photo' class='img-rounded' style='width:120px; height: 100px;'></td>

                                              
                                            <td>
                                                 <a href="edit_attraction.php?id=<?php echo $ps->id; ?>">
