                                      ...
                                      ?>
                                        <tbody>
                                          <?php foreach($product_set as $ps): ?>
                                            ...
                                            <td><?php echo $ps->sub_content; ?></td>
                                            <td> <img src='../about/<?php echo $ps->image; ?>' alt='Photo' class='img-rounded' style='width:120px; height: 100px;'></td>

                                              
                                            <td>
                                                 <a href="edit_about.php?id=<?php echo $ps->id; ?>">
