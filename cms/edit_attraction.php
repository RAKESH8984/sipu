...
if(empty($_GET['id'])) {
  ...
  $session->message_type("warning");
  redirect_to('view_attraction.php');
}else{
  $sel_product = attraction::find_by_id($_GET['id']);
}
?>
<?php
  if(request_is_post() && request_is_same_domain()) {
    ...
    $message_type = "danger";
      ...
      $pl = attraction::find_by_id($_GET['id']);
     ...
     if (!empty($_FILES["uploadedimage"]["name"])) {
      ...
      $image= uniqid().$ext;
      $pl->image = $image;
       move_uploaded_file($temp_name, "../attraction/".$image);
     ...
     else
     {
      ...
      if($pl->save()) {
        ...
        $session->message("attraction Successfully Updated.");
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="form" action="edit_attraction.php?id=<?php echo $sel_product->id; ?>" method="post" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
