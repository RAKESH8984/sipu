...
if(empty($_GET['id'])) {
  ...
  $session->message_type("warning");
  redirect_to('view_origin.php');
}else{
  $sel_product = origin::find_by_id($_GET['id']);
}
?>
<?php
  if(request_is_post() && request_is_same_domain()) {
    ...
    $message_type = "danger";
     ...
     if (!empty($_FILES["uploadedimage"]["name"])) {
      ...
      $image= uniqid().$ext;
      $pl->image = $image;
       move_uploaded_file($temp_name, "../origin/".$image);
       $path="../origin/".$image;
     ...
     else
     {
      ...
      if($pl->save()) {
        ...
        $session->message("origin Successfully Updated.");
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="form" action="edit_origin.php?id=<?php echo $sel_product->id; ?>" method="post" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                                       ...
                                       <div class="item form-group">
                                        ...
                                        <div class="item form-group">
                                         ...
                                         <div id="kv-avatar-errors" class="control-label col-md-3 col-sm-3 col-xs-12" style="width:800px;display:none"></div>
                                           ...
                                           <div class="col-md-9"> 
                                           <label class="control-label col-md-4 col-sm-4 col-xs-12">Present vide3o </label>
