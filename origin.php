...
<body class="home page page-id-203 page-template page-template-page-home-php">
	...
	<div class="w3-content w3-display-container">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1300px;height:450px;overflow:hidden;">
            <div>
                <img data-u="image" src="images/banner11.jpg" />
            </div>
        </div>
        <!-- Bullet Navigator -->
...
<h1 class="title-box_primary" style="color:#FF0066">Origin of Tara Devi</h1>
</div>
</div>
<div class="span7">
<div class="hero-unit ">
<?php $origin = origin::find_all();?>
<p align="justify"><?php echo $origin[0]->content; ?></p>
...
<p align="justify"><em><?php echo $origin[0]->sub_content; ?>.</em></p>
</div>
...
<image width="400" height="245" src='origin/<?php echo $origin[0]->image; ?>' frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></image>
</div>
</div>
</div>					<!-- .row (start) -->
		<!-- .row (end) -->
