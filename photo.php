...
<?php $photo_set = photo::find_all(); ?>
                         <?php foreach($photo_set as $photo): ?>
<ul class="posts-grid row-fluid unstyled mission">
<li class="span3" style="margin-right: 13px;">
<figure class="featured-thumbnail thumbnail">
<a href="photo/<?php echo $photo->image; ?>"</a>
<img src='photo/<?php echo $photo->image; ?>'/>
<span class="zoom-icon"></span></a></figure>
<div class="clear"></div>
<h5><a href="#"><?php echo $photo->content; ?></a></h5>
