...
<p align="justify"><?php echo $about[0]->content; ?></p>
...
<p align="justify"><em><?php echo $about[0]->sub_content; ?>.</em></p>
</div>
...
<image width="400" height="245" src='about/<?php echo $about[0]->image; ?>' frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></image>
</div>
</div>
</div>					<!-- .row (start) -->
		<!-- .row (end) -->
