...
<div class="span7">
<div class="hero-unit ">
<?php $festival = festival::find_all();?>
<p align="justify"><?php echo $festival[0]->content;?>. </p>
</div><!-- .hero-unit (end) -->
 <!-- .row (end) --></div>
<div class="span5">
<div class="#">
<iframe width="560" height="315" src="https://www.youtube.com/embed/undepjhP4YU" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
