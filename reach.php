...
<body class="home page page-id-203 page-template page-template-page-home-php">
	...
	<div class="w3-content w3-display-container">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1300px;height:450px;overflow:hidden;">
            <div>
                <img data-u="image" src="images/banner16.jpg" />
            </div>
        </div>
        <!-- Bullet Navigator -->
...
<h1 class="title-box_primary" style="color:#FF0066">How to reach the place Ugratara
</h1>
</div>
</div>
<div class="span7">
<div class="hero-unit ">
<?php $reach = reach::find_all();?>
<p><?php echo $reach[0]->content; ?>. </p>
</div><!-- .hero-unit (end) -->
 <!-- .row (end) --></div>
<div class="span5">
<div class="#">
<iframe width="460" height="259" src="https://www.youtube.com/embed/3orKHlXqY5s" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
</div>
</div>
</div>					<!-- .row (start) -->
		<!-- .row (end) -->
